...
<div id="page-content" style="padding-top: 100px;">
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                	<div class="text-center mb-4">
                        <h2 class="h2">Beautifies Company</h2>
            ...
            <div class="row">
            	<div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img src="{{ asset('usergueststyle/images/beautifes/Gambar/toner.png') }}" alt="About Us" /></div>
                <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img src="{{ asset('usergueststyle/images/beautifes/Gambar/serum.png') }}" alt="About Us" /></div>
                <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img src="{{ asset('usergueststyle/images/beautifes/Gambar/Untitled design (4).png') }}" alt="About Us"/></div>
            </div>
            <div class="row">
            	<div class="col-12">
